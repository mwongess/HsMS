    ...
    <div className="flex flex-col justify-between min-h-screen">
      <div>
        ...
        <div>
          ...
          <VisMisMotto data={{ icon: "", title: "Mission", description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus magnam dolore iste dolorem, animi quis laboriosam placeat officia ipsa labore!" }} />
          <VisMisMotto data={{ icon: "", title: "Motto", description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus magnam dolore iste dolorem, animi quis laboriosam placeat officia ipsa labore!" }} />
        </div>
        </div>
